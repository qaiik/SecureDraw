function w(h){let t=atob(h),s=t.length,i=new Uint8Array(s);for(let e=0;e<s;e++)i[e]=t.charCodeAt(e);return i}function S(h){return h.map(t=>[t>>8&255,t&255]).flat()}function L(h){let t=[];for(let s=0;s<h.length;s+=2)t.push(h[s]<<8|h[s+1]);return t}function x(h){return Array.from(h).map(t=>t.charCodeAt(0))}var g=class{#e;#s;#r;#t;#i=null;brushSize;currentColor;w;h;constructor(t,s,i=1,e="black",o=1){this.#e=document.createElement("canvas"),this.#t=[],this.#e.width=t,this.#e.height=s,this.w=t,this.h=s,this.#s="",this.brushSize=i,this.currentColor=e,this.#r=this.#e.getContext("2d")}#o(t,s){return Math.hypot(t.x-s.x,t.y-s.y)}resetLogPoint(){this.#i=null}drawCircle(t=5,s=0,i=0){t>255||(this.#r.beginPath(),this.#r.arc(s,i,t,0,2*Math.PI),this.#r.fillStyle=this.currentColor,this.#r.fill(),(!this.#i||this.#o(this.#i,{x:s,y:i})>=t/2)&&(this.#s+=`CIRCLE ${t} ${~~s} ${~~i}
...
`);for(let i of s){let e=i.split(" "),o=e[0];if(o==="SETCOLOR"){let r=e[1];this.setColor(r)}else if(o==="CIRCLE"){let r=e[1],n=e[2],a=e[3];this.drawCircle(r,n,a)}}}loadFromBinary(t,s=!0){this.#s="",this.#t=[];let i=0;for(;i<t.length;)switch(t[i]){case 1:let e=t[++i],o=[];for(let l=0;l<4;l++)i++,o.push(t[i]);this.drawCircle(e,...L(o)),i++;break;case 2:let r=t[++i],n=t.slice(i+1,i+1+r),a=String.fromCharCode(...n);i+=r,this.setColor(a);break;default:i++;break}}setSize(t){this.brushSize=t}setColor(t){this.currentColor=t,this.#s+=`SETCOLOR ${t}
`,this.#t.push(2,t.length,...x(t))}fromBase64(t,s=!0){return this.loadFromBinary(Array.from(w(t,s)))}toBase64(){let t="";for(let s=0;s<this.#t.length;s++)t+=String.fromCharCode(this.#t[s]);return btoa(t)}},b=class{#e;#s;#r=[];#t;#i;#o=null;constructor(t,s=1,i="black",e=1){this.publicCanvas=t,this.#e=document.createElement("canvas"),this.#i=[],this.#e.width=t.width,this.#e.height=t.height,this.w=t.width,this.h=t.height,this.#s="",this.brushSize=s,this.#t=this.#e.getContext("2d"),this.minSize=e,this.currentColor=i}#h(t,s){return Math.hypot(t.x-s.x,t.y-s.y)}resetLogPoint(){this.#o=null}drawCircle(t=5,s=0,i=0){this.#t.beginPath(),this.#t.arc(s,i,t,0,2*Math.PI),this.#t.fillStyle=this.currentColor,this.#t.fill(),(!this.#o||this.#h(this.#o,{x:s,y:i})>=t/2)&&(this.#s+=`CIRCLE ${t} ${~~s} ${~~i}
